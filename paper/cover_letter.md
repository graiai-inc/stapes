...
This journal published Ng et al. (2025), cited as reference 6 in this manuscript, which concluded that no standardized evaluation framework exists for clinical speech recognition. This work supplies one: an open, reproducible benchmark built entirely from publicly redistributable audio, with all code, per-model outputs, and normalization rules released under the MIT license so that other groups can extend, re-run, and critique it. The journal also published Nolan and Burke (2026), cited as reference 10, which measured transcription accuracy in simulated physician-patient encounters and found medical terminology errors to be disproportionately represented among semantically consequential errors. That study used the same evidentiary setting as this benchmark and, at twelve encounters with three standardized patients, points to exactly the scale limitation this work addresses.
...
**Author approval and concurrent submissions.** I am the sole author of this manuscript and I have approved it for submission. The content has not been published, and is not under consideration for publication, at any other journal, and no related manuscript from the author is in press or under review elsewhere.
...
**Suggested reviewers.** Should they be useful, the following have relevant expertise and no association with this work: Li Zhou, MD, PhD, Brigham and Women's Hospital / Harvard Medical School (lzhou@bwh.harvard.edu), an author of the cited work on speech-recognition errors in clinical documents; Kai Zheng, PhD, University of California, Irvine (kai.zheng@uci.edu), senior author of the cited work on non-lexical conversational sounds in ambient documentation; Bruce L. Lambert, PhD, Northwestern University (bruce.lambert@northwestern.edu), an author of the cited work on error in spoken medication orders; and Tobi Olatunji, MD, Intron Health (tobi@intron.io), an author of the cited work on ASR for medical entities in accented speech.
