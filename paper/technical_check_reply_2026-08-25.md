# Reply to the BMC MIDM technical check (sent 2026-08-25)

Manuscript fd95f4f4-d0e1-4858-a1b1-20c667d2605f v1.0, ref 62251619:1196208.
The technical check reported the two Zenodo DOI links as broken; both
resolve. Verified with `scripts/check_links.py` (log: `build/link_check.tsv`).
This is the text Grey sent, exported as `paper/doi_technical_submission.docx`
and `.pdf`.
...
These two DOIs are the persistent identifiers required for the cited dataset and for the archived analysis code, so I would prefer to retain them. If your system continues to flag them, I am happy to add the resolved record URLs (https://zenodo.org/records/4279041 and https://zenodo.org/records/22081372) alongside the DOIs — please let me know and I will make that change immediately.
