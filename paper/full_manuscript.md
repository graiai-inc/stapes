...
The OSCE respiratory interview dataset[10] contains 272 simulated patient-physician interviews focused on respiratory cases, recorded in a controlled OSCE examination setting; audio and manually corrected transcripts are available under a CC0 1.0 public-domain dedication on figshare.

PriMock57[11] contains 57 mock primary care consultations recorded between medical professionals acting as doctor and patient. The dataset includes audio recordings, utterance-level transcripts, and consultation notes, released under a CC-BY 4.0 license.
