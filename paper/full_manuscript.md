...
**Results:** On-device CTR was within 1–3 pp of the best cloud service per dataset. The standard-WER gap was 0.5–5.2 pp; the meaning-preserving-WER gap narrowed to 0.7–3.3 pp, consistent with differential backchannel handling. Medication names were the highest-error category for most models, with individual drugs misrecognized in over 60% of pooled occurrences; the most severe failures were concentrated on-device. ROVER yielded ≤ 0.82 pp gains; no advanced algorithm exceeded naive voting by more than 0.4 pp.
...
Model rankings differed between WER and CTR: whisper-turbo, second on overall WER, achieved the highest on-device CTR on two of three datasets. Medication names were the highest-error category for most models on every dataset, and individual drugs were misrecognized in 60% to 75% of pooled occurrences: wellbutrin 60.4% (psychiatric), lisinopril 74.6% and amoxicillin 73.7% (PriMock57), rosuvastatin 72.5% and ramipril 65.3% (OSCE). These extreme per-drug failures were concentrated in the on-device models; the best cloud services transcribed the same drugs nearly perfectly, although drug names remained the weakest cloud category on two of three datasets.
